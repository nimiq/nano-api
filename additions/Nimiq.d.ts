declare namespace Nimiq {
    ...
    class BasicAccount extends Account {
        ...
        public withContractCommand(transaction: Transaction, blockHeight: number, revert?: boolean): Account;
        public isInitial(): boolean;
        public type: Account.Type.BASIC;
    }
    ...
    class VestingContract extends Contract {
        ...
        public type: Account.Type.VESTING;
    }
    ...
    class NanoConsensus extends BaseConsensus {
        ...
        public _requestTransactionReceipts(address: Nimiq.Address): Promise<Nimiq.TransactionReceipt[]>;
        public _requestBlockProof(blockHash: Nimiq.Hash, blockHeight: number): Promise<Nimiq.BlockProofMessage[]>;
    }
